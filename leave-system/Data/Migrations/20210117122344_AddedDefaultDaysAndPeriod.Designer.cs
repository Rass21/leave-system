...
namespace leave_system.Data.Migrations
{
    ...
    [Migration("20210117122344_AddedDefaultDaysAndPeriod")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("leave_system.Data.LeaveAllocation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("leave_system.Data.LeaveHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("leave_system.Data.LeaveType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("leave_system.Models.LeaveTypeViewModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("leave_system.Data.LeaveAllocation", b =>
                {
                    ...
                    b.HasOne("leave_system.Data.LeaveType", "LeaveType")
                        .WithMany()
            ...
            modelBuilder.Entity("leave_system.Data.LeaveHistory", b =>
                {
                    b.HasOne("leave_system.Data.Employee", "ApprovedBy")
                        .WithMany()
                    ...
                    b.HasOne("leave_system.Data.Employee", "RequestingEmployee")
                        .WithMany()
